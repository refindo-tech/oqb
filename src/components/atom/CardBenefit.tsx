...
const CardBenefit: React.FC<{ title: string; description: string; path:string }> = ({
  ...
  return (
    <div
      ...
      className={`rounded-full h-[300px] w-[300px] text-center ${isHover ? 'bg-greenWhite backdrop-blur-lg text-navy font-semibold': 'bg-transparent'} p-10 flex flex-col justify-center items-center gap-3 transition-all ease-out duration-1000`}
    >
      {!isHover&&
