...
const LoginPage = () => {
  ...
  return (
    <main className="w-full min-h-screen font-poppins flex items-center justify-center p-5">
      <form onSubmit={handleSubmitLogin} method="POST" className="rounded-2xl bg-white border-[1px] border-border shadow-md lg:w-[50%] p-5 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-center text-xs text-primerText font-semibold ">Apakah anda belum memiliki akun? <Link href={"/auth/register"} className="text-softBlue">Daftar</Link></p>
        </div>
      </form>
    </main>
  );
